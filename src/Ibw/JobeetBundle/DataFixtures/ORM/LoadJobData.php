<?php
namespace Ibw\JobeetBundle\DataFixtures;
...
class LoadJobData extends AbstractFixture implements
    OrderedFixtureInterface
{
    public function load(ObjectManager $em)
    {
        ...
        $job_sensio_labs->setUrl('http://www.angusty.com/');
        ...
        $job_extreme_sensio->setUrl('https://www.baidu.com/');
        ...
        $job_expired->setUrl('http://www.yiweimi.cn/');
